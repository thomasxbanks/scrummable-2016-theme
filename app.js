...
// Show/hide Masthead
if(scroll>screen_height/2){$('.home #masthead.fade-in').addClass('open');}else{$('.home #masthead.fade-in').removeClass('open');}if(scroll>screen_height){$('#masthead [aria-label="Skip to content"] .fa').removeClass('fa-arrow-down');$('#masthead [aria-label="Skip to content"] .fa').addClass('fa-arrow-up');}else{$('#masthead [aria-label="Skip to content"] .fa').removeClass('fa-arrow-up');$('#masthead [aria-label="Skip to content"] .fa').addClass('fa-arrow-down');}//console.log("doc_height: "+document_height+". \nscreen_height: "+screen_height+". \ndoc - screen: "+(document_height - screen_height)+". scroll: "+scroll);
